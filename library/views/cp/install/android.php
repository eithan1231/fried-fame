...
// https://eithan.me/
//
// \library\views\cp\install\android.php
//
// ======================================
...
<html lang="en" dir="ltr" style="--sidebar-width: <?= $ff_config->get('sidebar-width') ?>">
	<head>
		<meta charset="utf-8">
		<title><?= ff_esc(ff_buildTitle('title-android-install', $language)) ?></title>
	      ...
	      <div class="row">
	        <div class="col-sm-8">
	          ...
	          <div>
	            ...
	            <p>This is a guide to using <?= $ff_config->get('project-name') ?> on Android.</p>
	            <hr>
							...
							<div id="install">
								...
								<p>We are in thep rogress of developing all clients. So hopefully the Android client will be available to public soon.</p>
