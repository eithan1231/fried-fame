...
* Spanish
*/
class language_spanish extends language_abstract implements language_interface
{
	private $languageName = 'Español';
	private $languageCode = 'es';
