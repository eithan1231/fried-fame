...
// https://eithan.me/
//
// \library\routes\containers\windows\api\heartbeet.php
//
// ======================================


class routes_containers_windows_api_heartbeet extends route
{
	/**
	...
	*/
	...
	{
		return [
      '/containers/windows/api/heartbeet',
		];
	}
