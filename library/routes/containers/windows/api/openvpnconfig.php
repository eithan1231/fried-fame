...
// https://eithan.me/
//
// \library\routes\containers\windows\api\openvpnconfig.php
//
// ======================================


class routes_containers_windows_api_openvpnconfig extends route
{
	/**
	...
	*/
	...
	{
		return [
      '/containers/windows/api/openvpn-config',
		];
	}
	...
	*/
    ...
    global $ff_router, $ff_context;
		...
		$node_id = $ff_request->get('node');
		$node_auth_key = $ff_request->get('node_auth');// Not required.
		if(!$node_id) {
