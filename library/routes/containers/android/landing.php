...
// https://eithan.me/
//
// \library\routes\containers\android\landing.php
//
// ======================================


class routes_containers_windows_landing extends route
{
	/**
	...
	*/
    ...
    if(!containers::handleAndroid($this->getName(), $request, $response)) {
      return true;
    }
