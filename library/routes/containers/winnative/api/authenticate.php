...
// https://eithan.me/
//
// \library\routes\containers\winnative\api\authenticate.php
//
// ======================================


class routes_containers_winnative_api_authenticate extends route
{
	/**
	...
	*/
	...
	{
		return [
      '/containers/winnative/api/authenticate',
		];
	}
	...
	*/
    ...
    global $ff_router, $ff_context;
		...
		if(postlimiter::exceedsRequestLimit('winnative-auth', $request, $limit, $limitTimespan, $activeCount)) {
		...
		if(!$user) {
			postlimiter::insertRequest('winnative-auth', $request);
			return $response->json([
