...
// https://eithan.me/
//
// \library\routes\containers\winnative\api\openvpnconfig.php
//
// ======================================


class routes_containers_winnative_api_openvpnconfig extends route
{
	/**
	...
	*/
	...
	{
		return [
      '/containers/winnative/api/openvpn-config',
		];
	}
