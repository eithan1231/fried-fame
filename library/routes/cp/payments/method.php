...
// https://eithan.me/
//
// \library\routes\cp\payments\method.php
//
// ======================================


class routes_cp_payments_method extends route
{
	/**
	...
	*/
	...
	{
		return [
      '/payments/select-gateway/{plan-id-name}',
    ];
	}
	...
	*/
    ...
    $planid = ff_getIdFromMergedIdAndSubject($parameters['plan-id-name']);
