...
// https://eithan.me/
//
// \library\routes\cp\mod\group\landing.php
//
// ======================================


class routes_cp_mod_group_landing extends route
{
	/**
	...
	*/
	public function run(array $parameters, request &$request, response &$response)
	{
      ...
      return true;
		...
		if(!$ff_context->getSession()->getActiveLinkUser()->getGroup()->can('mod_groups')) {
