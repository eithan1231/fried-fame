...
// https://eithan.me/
//
// \library\routes\cp\mod\support\list.php
//
// ======================================


class routes_cp_mod_support_list extends route
{
	/**
	...
	*/
	public function run(array $parameters, request &$request, response &$response)
	{
      ...
      return true;
		...
		if(!$ff_context->getSession()->getActiveLinkUser()->getGroup()->can('mod_support')) {
