...
// https://eithan.me/
//
// \library\routes\cp\mod\package\landing.php
//
// ======================================


class routes_cp_mod_package_landing extends route
{
	/**
	...
	*/
	public function run(array $parameters, request &$request, response &$response)
	{
      ...
      return true;
		...
		if(!$ff_context->getSession()->getActiveLinkUser()->getGroup()->can('mod_packages')) {
