...
// https://eithan.me/
//
// \library\routes\cp\mod\nodes\manage.php
//
// ======================================


class routes_cp_mod_nodes_manage extends route
{
	/**
	...
	*/
	public function run(array $parameters, request &$request, response &$response)
	{
      ...
      return true;
		...
		if(!$ff_context->getSession()->getActiveLinkUser()->getGroup()->can('mod_nodes')) {
