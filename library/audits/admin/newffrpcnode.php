...
class audits_admin_newffrpcnode extends audits_admin_abstract implements audits_interface
{
  const AUDIT_NAME = 'newffrpcnode';
  ...
  */
  public function renderSnippet(array $value)
  {
    global $ff_sql, $ff_context;
		...
		echo $ff_context->getLanguage()->getPhrase('audit-admin-newffrpcnode', [
