...
// https://eithan.me/
//
// \library\audits\admin\opensupportticket.php
//
// ======================================


class audits_admin_opensupportticket extends audits_admin_abstract implements audits_interface
{
  const AUDIT_NAME = 'opensupportticket';
  ...
  */
  public function renderSnippet(array $value)
  {
    ...
    if($thread->success) {
      echo $ff_context->getLanguage()->getPhrase('audit-admin-thread-opened', [
				'ticket_id' => $thread_id,
